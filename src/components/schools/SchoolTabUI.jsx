...
import { FiUsers, FiShoppingBag, FiPlus, FiAlertTriangle, FiDollarSign } from 'react-icons/fi';
...
const SchoolTabUI = ({
  ...
  const getTabIcon = () => {
    switch (selectedTab) {
      case 0: return <FiShoppingBag className="w-5 h-5 text-red-600 dark:text-red-400" />;
      case 1: return <FiUsers className="w-5 h-5 text-red-600 dark:text-red-400" />;
      case 2: return <FiAlertTriangle className="w-5 h-5 text-red-600 dark:text-red-400" />;
      case 3: return <FiDollarSign className="w-5 h-5 text-red-600 dark:text-red-400" />;
      default: return <FiShoppingBag className="w-5 h-5 text-red-600 dark:text-red-400" />;
    }
  };
                ...
                className={({ selected }) =>
                  classNames(
                    ...
                    selected
                      ...
                      : 'text-gray-600 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 hover:bg-white dark:hover:bg-gray-700/50'
                  )
                }
              >
